...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "jxau.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "jxau.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "jxau.mail.routing.key";
}
