                ...
                <el-table-column label="所属部门" align="center">
                    <template slot-scope="scope">
                        <el-tooltip placement="right" v-if="scope.row.salary">
                            ...
                            <el-tag effect="dark" type="primary">{{scope.row.salary.name}}</el-tag>
                        </el-tooltip>
                        <el-tag effect="dark" type="info" v-else>暂未设置</el-tag>
                    </template>
                </el-table-column>
...
<script>
    export default {
        ...
        methods: {
            ...
            hidePop(data) {
                //alert(this.currentSalary)
                //alert(data.salary.id)
